<div>
    <div class="promise custom-control custom-checkbox" style="width: auto; flex: 0 0 16px">
        <input wire:model="confirmed" type="checkbox" id="customCheck1" [(ngModel)]="checkboxValue" (change)="toggleEditable()">
