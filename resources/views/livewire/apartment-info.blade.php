            ...
            <div class="col-12 row">
                ...
                <div class="col-6">
                    <div class="form-group mt-3">
                        ...
                        <select {{ $disableDistrict ? 'disabled' : '' }}  wire:model="district"  name="unitDistrictID" class="form-control" id="districts">
                            <option value="" selected>برجاء الإختيار</option>
            ...
            <div class="col-12 row">
                <div class="col-6">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select {{ $disableSubDistrict ? 'disabled' : '' }}  wire:model="subDistrict" name="unitSubDistrictID" class="form-control" id="subDistricts">
                            <option value="" selected>برجاء الإختيار</option>
